...
module eragon::eragon_coin {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ERAGON";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            constructor_ref,
            option::none(),
            utf8(b"Eragon Coin"), /* name */
            utf8(ASSET_SYMBOL), /* symbol */
            8, /* decimals */
            utf8(b"http://eragon.gg/favicon.ico"), /* icon */
            utf8(b"http://eragon.gg"), /* project */
        );
    ...
    #[test_only]
    public fun initial_test(admin: &signer) {
        let constructor_ref = &object::create_named_object(admin, ASSET_SYMBOL);
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            constructor_ref,
            option::none(),
    ...
    public fun get_metadata(): Object<Metadata> {
        let asset_address = object::create_object_address(&@eragon, ASSET_SYMBOL);
    ...
    public entry fun set_pause(pauser: &signer, paused: bool) acquires State {
        ...
        let state = borrow_global_mut<State>(object::create_object_address(&@eragon, ASSET_SYMBOL));
    ...
    fun assert_not_paused() acquires State {
        let state = borrow_global<State>(object::create_object_address(&@eragon, ASSET_SYMBOL));
...
/* 
    ...
    #[test(creator = @eragon, aaron = @0xface)]
